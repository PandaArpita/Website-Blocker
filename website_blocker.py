...
Label(window,text='Developed By @Arpita22',font=('bold',12),fg='purple').pack(side=BOTTOM)
...
Button(window,text='Exit',font=('bold',10),bg='brown',fg='white',command=close).place(x=400,y=100)
window.mainloop()